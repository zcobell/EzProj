        ...
        PROGRAM TEST_EZPROJ_CPP
            ...
            REAL(8),PARAMETER :: x_original = -90.3661965220D0
            REAL(8),PARAMETER :: y_original = 30.0573591369D0
            REAL(8),PARAMETER :: x_expected = -35625.789763D0
            REAL(8),PARAMETER :: y_expected = 3343350.030257D0
            ...
            CALL ezproj_cpp(lambda0,phi0,x_original,y_original,x_out,y_out,ierr)
